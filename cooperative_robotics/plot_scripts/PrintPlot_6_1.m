function [ ] = PrintPlot_6_1( plt, uvms )
...
% % Plot velocities of tool and vehicle in vehicle frame
fig = figure();hold on;;

hplot = plot(plt.t, vecnorm(plt.v_p_dot(1:3,:)));
hplot = plot(plt.t, vecnorm(plt.v_p_dot_tool(4:6,:)));
%set(gca,'ColorOrderIndex',1)
set(hplot, 'LineWidth', 2);
%set(hplot(4), 'LineWidth', 3);
